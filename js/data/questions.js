window.questions = {
  ar: [
    {
      ...
      options: [
        { text: "أخطط ليومي بسرعة", trait: "D", score: 4 },
    ...
    {
      id: 3,
      text: "ما هو مصدر قوتك الداخلية؟",
      options: [
        { text: "إرادتي القوية وتصميمي", trait: "D", score: 4 },
        { text: "طاقتي الإيجابية وابتسامتي", trait: "I", score: 4 },
        { text: "هدوئي وثباتي الداخلي", trait: "S", score: 4 },
        { text: "تفكيري المنطقي وتحليلي", trait: "C", score: 4 }
      ]
    },
    {
      id: 4,
      text: "ما الذي يُشعرك بالتوتر أكثر؟",
      options: [
        { text: "عدم التحكم في الموقف", trait: "D", score: 3 },
        { text: "الوحدة أو العزلة", trait: "I", score: 3 },
        { text: "التغيرات المفاجئة", trait: "S", score: 3 },
        { text: "الأخطاء أو الفوضى", trait: "C", score: 4 }
      ]
    },
    {
      id: 5,
    ...
    {
      id: 15,
      text: "ما نوع القيادة التي تُلهمك؟",
      options: [
  ...
  en: [
    {
      id: 1,
      text: "When you wake up in the morning, what's the first thing on your mind?",
      options: [
        { text: "I quickly plan my day", trait: "D", score: 4 },
    ...
    {
      id: 2,
      text: "In a new social gathering, what do you do?",
      options: [
    ...
    {
      id: 3,
      text: "What is your inner source of strength?",
      options: [
        { text: "My strong will and determination", trait: "D", score: 4 },
        { text: "My positive energy and smile", trait: "I", score: 4 },
        { text: "My inner calm and stability", trait: "S", score: 4 },
        { text: "My logical thinking and analysis", trait: "C", score: 4 }
      ]
    },
    {
      id: 4,
      ...
      options: [
        { text: "Losing control of the situation", trait: "D", score: 3 },
        { text: "Loneliness or isolation", trait: "I", score: 3 },
        { text: "Unexpected changes", trait: "S", score: 3 },
        { text: "Mistakes or chaos", trait: "C", score: 4 }
      ]
    },
    {
      id: 5,
      text: "How do you deal with mistakes?",
      options: [
        { text: "I learn and move on quickly", trait: "D", score: 4 },
        { text: "I analyze what happened in detail", trait: "C", score: 4 },
        { text: "I feel guilty but forgive myself", trait: "S", score: 3 },
        { text: "I wonder: does this prove I'm not enough?", trait: "S", score: 2 }
      ]
    },
    {
      id: 6,
      ...
      options: [
        ...
        { text: "Supporting someone in crisis", trait: "S", score: 4 },
        { text: "Coming up with a new idea", trait: "I", score: 4 },
        { text: "Fulfilling duties and responsibilities", trait: "C", score: 3 }
      ]
    },
    {
      id: 7,
      text: "What do you look for in an important decision?",
      options: [
    ...
    {
      id: 9,
      text: "What type of books or content do you prefer?",
      options: [
    ...
    {
      id: 10,
      text: "What gives you a sense of meaning?",
      options: [
        { text: "Achieving great accomplishments", trait: "D", score: 4 },
        { text: "Helping others", trait: "S", score: 4 },
    ...
    {
      id: 11,
      text: "How often do you change your mind based on new information?",
      options: [
    ...
    {
      id: 12,
      text: "What makes you feel comfortable?",
      options: [
        { text: "Achieving the goal", trait: "D", score: 4 },
        { text: "Laughter and interaction", trait: "I", score: 4 },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "I suffer but I learn", trait: "S", score: 3 },
        { text: "I analyze it and benefit from it", trait: "C", score: 4 }
      ]
    },
    {
      id: 15,
      text: "What type of leadership inspires you?",
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: "I celebrate it and immerse myself in it", trait: "I", score: 4 },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Maintaining stability and security", trait: "S", score: 4 },
        { text: "Understanding the truth and reaching perfection", trait: "C", score: 4 }
      ]
    },
    {
      id: 20,
